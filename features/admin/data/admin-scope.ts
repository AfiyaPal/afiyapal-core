...
export const adminModules = [
  ...
  { key: "settings", name: "Admin Settings", route: "/admin/settings", summary: "Configure Stage 2 platform safety defaults, supported languages, disclaimers, and escalation rules.", mvpIncludes: ["Supported language settings", "Emergency guidance text", "AI disclaimer defaults", "Doctor verification requirements", "Content review intervals", "Support contact settings"] }
] as const;
