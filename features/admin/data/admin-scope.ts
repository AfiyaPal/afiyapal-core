...
export const adminModules = [
  ...
  { key: "facilities", name: "Facility Management", route: "/admin/facilities", summary: "Review, approve, and manage health facility registrations.", mvpIncludes: ["Facility list with verification status", "Approve, reject, and suspend actions", "Facility type, location, and contact info", "Linked professionals overview", "Verified-by and reviewed-on tracking"] },
  ...
  { key: "contact-submissions", name: "Contact Submissions", route: "/admin/contact-submissions", summary: "Review homepage contact form enquiries, services requested, and follow-up status.", mvpIncludes: ["Contact form inbox", "Service interest tags", "Email and phone follow-up", "Status workflow", "Rate-limit and IP-hash audit context"] },
  ...
  { key: "testing", name: "Testing Checklist", route: "/admin/testing", summary: "Run Stage 2 release checks for access control, role permissions, AI safety, privacy, tables, and audit logs.", mvpIncludes: ["Role-based access QA", "Doctor and content permission checks", "AI flag and consultation workflow checks", "Sensitive health access verification", "Search, filters, pagination, and audit evidence"] },
